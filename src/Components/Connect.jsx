  ...
  const students = [
    {
      name: "Raghav Matta",
      description:
        "Sophomore @VIT | Full Stack Developer | Ex-Microsoft Intern",
      image:
    ...
    {
      name: "Yash Bawa",
      description: "Senior @VIT | Android Developer | Google Intern",
      image:
        "https://chicagophotovideo.com/wp-content/uploads/2017/10/ezgif.com-webp-to-jpg-17.jpg",
      connected: true,
    },
    {
      name: "Rohit Bansal",
      description: "Junior @VIT | Backend Developer | Facebook Intern",
      image:
    ...
    {
      name: "Aryan Signh",
      description: "Freshman @VIT | Blogger",
      image:
    ...
    {
      name: "Raghav Matta",
      description: "Sophomore @VIT | Content Creator | Ex-Microsoft Intern",
      image:
        "https://writestylesonline.com/wp-content/uploads/2019/01/What-To-Wear-For-Your-Professional-Profile-Picture-or-Headshot.jpg",
      connected: true,
    },
    ...
    <div className="flex bg-gray-100">
      ...
      <div className="p-4 w-full text-[#184E77]">
        ...
        <div className="pt-12">
          ...
          <div className="w-full grid md:grid-cols-2 grid-cols-1 gap-4 pt-4">
            {students.map((student) => (
              <div className="flex gap-4 bg-blue-200 rounded-lg p-2 relative shadow hover:scale-105 transition duration-300">
                ...
                <div className="text-xl flex items-center">{student.name}</div>
                <div className="flex items-center">{student.description}</div>
                <div className="flex items-center right-4 top-4 absolute">
                  {!student.connected && <i className="fa fa-user-plus"></i>}
                </div>
              </div>
            ))}
          </div>
